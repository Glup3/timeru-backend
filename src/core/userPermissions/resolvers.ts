...
import UserPermission from '../../db/models/UserPermission.model';
import Project from '../../db/models/Project.model';
import Permission from '../../db/models/Permission.model';
import { MutationAddUserPermissionArgs } from '../../generated/graphql';
...
export const addUserPermission = authenticated(
  validateRole(ROLE_ADMIN)(
    ...
    async (_: any, { userPermissionInput }: MutationAddUserPermissionArgs): Promise<UserPermissionMutationResponse> => {
